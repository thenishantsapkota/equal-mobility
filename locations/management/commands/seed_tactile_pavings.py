...
class Command(BaseCommand):
    help = "Fetches tactile paving related data in Django Models"
    ...
    def handle(self, *args, **kwargs):
        ...
        (
        node(area.searchArea)["tactile_paving"="yes"];
        way(area.searchArea)["tactile_paving"="yes"];
        relation(area.searchArea)["tactile_paving"="yes"];
        );
        out center;
        """
        ...
        for element in result.nodes + result.ways + result.relations:
            ...
            accessibility_feature = "tactile_paving"
